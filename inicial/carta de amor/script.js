...
function verificarProgressoEpilogo() {
    ...
    if (usuarioLogadoStr) {
        ...
        if (progressoLeitura.capitulo8) {
            ...
            hint.innerText = "Dica: 33-02-15   97-02-20   157-17-31   11-01-13   49-14-01   128-16-24   17-08-13   47-16-01   80-27-34   171-15-37";
            hintButton.style.display = 'block'; // Exibe o botão "Já sei a senha"

            hintButton.addEventListener("click", function() {
                message.innerText = "Digite a senha (Há distinção entre letras maiúsculas e minúsculas)"; // Atualiza a mensagem
                hint.innerText = "";
